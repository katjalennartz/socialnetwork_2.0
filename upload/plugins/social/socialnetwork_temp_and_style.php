...
function socialnetwork_addtemplates()
{
    ...
    $template[3] = array(
        ...
        <a href="member.php?action=profile&uid={$thispage}&area=socialnetwork&postdelete={$sn_postid}" onClick="return confirm(\\\'{$lang->socialnetwork_deletepost}\\\');" class="editDelete" ><i class="fas fa-trash"></i></a>',
        "sid" => "-2",
        "version" => "1.0",
        "dateline" => TIME_NOW
    );
...
{$socialnetwork_ucp_pmAlert}
    ...
    $template[13] = array(
        ...
        <a href="member.php?action=profile&uid={$thispage}&area=socialnetwork&ansdelete={$ansid}"  onClick="return confirm(\\\'{$lang->socialnetwork_deletepost}\\\');" class="editDelete" ><i class="fas fa-trash"></i></a>
